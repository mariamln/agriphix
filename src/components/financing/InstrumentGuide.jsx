...
import { FinanceInstrumentIcon, Scale, CheckCircle } from '@/constants/valueChainIcons';
          ...
          <div key={name} className="border border-emerald-100 bg-emerald-50/50 rounded-xl p-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-emerald-100 flex items-center justify-center shrink-0">
                <FinanceInstrumentIcon instrument={name} className="w-5 h-5 text-emerald-700" />
              </div>
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3 text-xs">
                  <span className="text-gray-500 flex items-center gap-1">
                    ...
                    Best for: <span className="text-gray-700 font-medium">{inst.best_for}</span>
                  </span>
                </div>
                <div className="mt-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-1.5 text-xs text-amber-800 flex items-start gap-1.5">
                  <Scale className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                  <span><strong>Shari&apos;ah note:</strong> {inst.shariah_note}</span>
                </div>
              </div>
            </div>
          </div>
